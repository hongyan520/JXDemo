 ...
 * @date 2013-8-16
 */
public class PushLoadListView extends ListView implements OnScrollListener
{
	...
	private OnClickAvoidForceListener moreClickListner;
	...
	public PushLoadListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(context);
	}
	...
	public void setMoreClickListner(OnClickAvoidForceListener moreClickListner)
	{
		footView.setVisibility(View.VISIBLE);
		this.moreClickListner = moreClickListner;
		footView.setOnClickListener(moreClickListner);
